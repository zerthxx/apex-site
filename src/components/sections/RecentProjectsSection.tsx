    ...
    <section ref={ref} className="py-20 bg-surface/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {PROJECTS.map(({ id, name, service, description, techs, emoji, gradient }, i) => (
            <motion.div
              key={id}
            ...
            >
              ...
              <div className="p-5 flex flex-col gap-3">
                <h3 className="font-heading font-semibold text-ink text-sm leading-snug">{name}</h3>
                <p className="text-ink-ghost text-xs leading-relaxed flex-1">{description}</p>
