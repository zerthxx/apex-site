  ...
  const sidebarContent = (
    <div className="flex flex-col h-full">
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-4 flex flex-col gap-1">
        ...
        {isStaff && (
          <>
            <p className="text-[10px] font-semibold uppercase tracking-widest text-ink-ghost px-3 pt-4 pb-1">
              CRM
            </p>
            <SidebarLink
              href="/crm/liidit"
        ...
        {isAdmin && (
          <>
            ...
            <SidebarLink
              href="/admin/logi"
              label="Aktiviteettiloki"
              icon={<ShieldCheck size={16} />}
              onClick={onMobileClose}
            />
            <SidebarLink
              href="/admin/analytiikka"
              label="Analytiikka"
            ...
            />
            <SidebarLink
              href="/admin/sahkopostipohjat"
              label="Sähköpostipohjat"
              icon={<Mail size={16} />}
              onClick={onMobileClose}
            />
            <SidebarLink
