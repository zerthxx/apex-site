    ...
    <div>
      ...
      {projectToDelete && (
        <ConfirmDialog
          ...
          message={`Projekti "${projectToDelete.name}" siirretään roskakoriin yhdessä sen tehtävien, tiedostojen ja kommenttien kanssa. Vain omistaja voi palauttaa tai poistaa pysyvästi.`}
